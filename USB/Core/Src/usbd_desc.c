...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define USBD_VID                      0x35E3 // 0x0483
#define USBD_PID                      0xCAD6   /* Replace '22336' with your device product ID */
#define USBD_LANGID_STRING            1033   /* Replace '0xbbb' with your device language ID */
#define USBD_MANUFACTURER_STRING      "CadStar" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "Battery Charger Station" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "Battery Charger Station" /* Add your product Full Speed string */
...
#define USBD_INTERFACE_FS_STRING      "CDC Interface string" /* Add your Interface Full Speed string */
